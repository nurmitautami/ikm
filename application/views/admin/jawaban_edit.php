                                    ...
                                    <form action="" method="post">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="text" class="form-control input-default" name="judul" value="<?php echo $jwbid['jawab_jenis']; ?>" autofocus>
                                                <small class="text-danger"><?php echo form_error('judul'); ?></small>
                                            </div>
                                            <div class="form-group col-md-4">
                                                <label>Jenis Emoji</label>
                                                <input type="text" class="form-control input-default" name="emoji" value="<?php echo $jwbid['jawab_emoji']; ?>">
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="text" class="form-control input-default" name="type" value="<?php echo $jwbid['jawab_type_text']; ?>">
